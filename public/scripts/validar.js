...
function validar(event) {
  ...
  contra=(/^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])([a-zA-Z0-9]{8})$/);

  if (usuario === "" ||nombre === "" || apellido === "" ||pass === "" || edad === "" || email === "") {
    ...
    alert("la contraseña debe contener minimamente un caracter numerico,una mayuscula y una minuscula");
    event.returnValue = false;
  }
